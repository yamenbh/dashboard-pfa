    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Invitations</BlockTitle>
              <BlockDes className="text-soft">
                <p>You have total 2 Invitations.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
              ...
              <div className="card-inner">
                <div className="card-title-group">
                  <div className="card-title">
                    <h5 className="title">All Invitations</h5>
                  </div>
                  ...
                  <thead className="tb-odr-head">
                    <tr className="tb-odr-item">
                      <th className="tb-odr-info">
                        <span className="tb-odr-id">Invitation ID</span>
