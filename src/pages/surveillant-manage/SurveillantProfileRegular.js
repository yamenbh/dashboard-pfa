...
const SurveillantProfileRegularPage = ({ sm, updateSm, setProfileName }) => {
  ...
  const [surveillantInfo, setSurveillantInfo] = useState(surveillantData[0]);
  ...
  useEffect(()=>{
    ...
    setFormData(JSON.parse(surveillant))
  }, [])
  ...
  const submitForm = () => {
    ...
    setSurveillantInfo(submitData);
    setModal(false);
  };

  return (
    <React.Fragment>
      <Head title="Surveillant List - Profile"></Head>
      <BlockHead size="lg">
        <BlockBetween>
          <BlockHeadContent>
        ...
        <div className="nk-data data-list">
          ...
          <div className="data-item" onClick={() => setModal(true)}>
            <div className="data-col">
              ...
              <span className="data-value">{currentSurveillant?.name}</span>
            </div>
          ...
          <div className="data-item">
            <div className="data-col">
              ...
              <span className="data-value">{currentSurveillant?.email}</span>
            </div>
            <div className="data-col data-col-end">
          ...
          <div className="data-item" onClick={() => setModal(true)}>
            <div className="data-col">
              ...
              <span className="data-value text-soft">{currentSurveillant?.phone}</span>
            </div>
            <div className="data-col data-col-end">
              <span className="data-more">
                <Icon name="forward-ios"></Icon>
...
export default SurveillantProfileRegularPage;
